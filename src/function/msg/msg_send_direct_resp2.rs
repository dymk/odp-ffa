...
impl MsgSendDirectResp2 {
    pub fn new(
        ...
        destination_id: u16,
        uuid: Uuid,
        data: impl Into<RegisterPayload>,
    ) -> Self {
        Self(DirectMessage {
            source_id,
            destination_id,
    ...
    pub fn from_req_with_payload(
        req: &MsgSendDirectReq2,
        payload: impl Into<RegisterPayload>,
    ) -> Self {
        Self(DirectMessage {
...
mod tests {
    ...
    fn test_msg_send_direct_resp2_round_trip(
        ...
        let original_resp =
            MsgSendDirectResp2::new(source_id, destination_id, uuid, payload.clone());
